...
describe('StormGlass client', () => {
  ...
  it('should return the normalized forecast from the StormGlass service',
    async () => {
      ...
      mockedAxios.get = jest.fn().mockResolvedValue({data: stormGlassWeather3HoursFixture});
  ...
  it('should get a generic error from StormGlass service when the request fail before reaching the service',
    async () => {
      const lat = -33.792726;
      const lng = 151.289824;
